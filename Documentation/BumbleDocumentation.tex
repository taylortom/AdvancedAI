...
We modified most of Bumble's behaviour with regards to the NPCs.

Quite a key 

\begin{itemize}
	\item The hornets follow Bumble upon spying him.
	\item Bumble no longer flees if in possession of the shield/sword
	\item Hornets no longer cause injury if Bumble's in possession of the bugspray. Also, the bugspray now actually works
\end{itemize}
